CREATE ROLE scorehub_user WITH LOGIN PASSWORD '***';
CREATE DATABASE scorehub OWNER scorehub_user;

GRANT ALL PRIVILEGES ON DATABASE scorehub TO scorehub_user;
...
GRANT ALL ON SCHEMA public TO scorehub_user;
GRANT USAGE ON SCHEMA public TO scorehub_user;

-- Grant on existing objects in public schema
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO scorehub_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO scorehub_user;

-- Ensure future objects in public schema also get privileges
ALTER DEFAULT PRIVILEGES FOR ROLE scorehub_user IN SCHEMA public
    GRANT ALL ON TABLES TO scorehub_user;
ALTER DEFAULT PRIVILEGES FOR ROLE scorehub_user IN SCHEMA public
    GRANT ALL ON SEQUENCES TO scorehub_user;
